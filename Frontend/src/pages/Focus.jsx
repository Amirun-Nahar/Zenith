...
export default function Focus() {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <h1 className="text-xl sm:text-2xl font-semibold" style={{ color: '#F5EFE6' }}>Focus Mode</h1>
      <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
        <div className="card p-4 sm:p-6 flex flex-col items-center">
          <div className="text-xs sm:text-sm mb-2" style={{ color: '#F5EFE6', opacity: 0.8 }}>
            {mode === 'work' ? 'Work session' : mode === 'break' ? 'Break session' : 'Ready'}
          </div>
          <div className="text-5xl sm:text-6xl font-bold tracking-tight" style={{ color: '#F5EFE6' }}>{mm}:{ss}</div>
        ...
        <div className="card p-4 sm:p-6">
          <h2 className="text-lg font-medium mb-2" style={{ color: '#F5EFE6' }}>Productivity Pet</h2>
          <p className="text-xs sm:text-sm mb-3 sm:mb-4" style={{ color: '#F5EFE6', opacity: 0.8 }}>
          ...
          <div className="text-xs sm:text-sm mt-2 sm:mt-3" style={{ color: '#F5EFE6', opacity: 0.8 }}>
            Completed sessions: <span className="font-medium" style={{ color: '#F5EFE6' }}>{completed}</span>
          </div>
        </div>
      </div>
    </div>
